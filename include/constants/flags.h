...
#define FLAG_REGISTERED_CHRRYCLOVE           (TRAINER_REGISTERED_FLAGS_START + REMATCH_CHRRYCLOVE)
#define FLAG_REGISTERED_TOASTER              (TRAINER_REGISTERED_FLAGS_START + REMATCH_TOASTER)
#define FLAG_REGISTERED_ERMII                (TRAINER_REGISTERED_FLAGS_START + REMATCH_ERMII)
