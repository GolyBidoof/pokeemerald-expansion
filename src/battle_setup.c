...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_CHRRYCLOVE] = REMATCH(TRAINER_CHRRYCLOVE_1, TRAINER_CALVIN_2, TRAINER_CALVIN_3, TRAINER_CALVIN_4, TRAINER_CALVIN_5, ROUTE102),
    [REMATCH_TOASTER] = REMATCH(TRAINER_TOASTER_1, TRAINER_CALVIN_2, TRAINER_CALVIN_3, TRAINER_CALVIN_4, TRAINER_CALVIN_5, ROUTE102),
    [REMATCH_ERMII] = REMATCH(TRAINER_ERMII_1, TRAINER_CALVIN_2, TRAINER_CALVIN_3, TRAINER_CALVIN_4, TRAINER_CALVIN_5, ROUTE102),
    [REMATCH_MUSTEKALAN] = REMATCH(TRAINER_MUSTEKALAN_1, TRAINER_CALVIN_2, TRAINER_CALVIN_3, TRAINER_CALVIN_4, TRAINER_CALVIN_5, ROUTE102),
...
static void CB2_GiveStarter(void)
{
    ...
    *GetVarPointer(VAR_STARTER_MON) = gSpecialVar_Result;
    ...
    ScriptGiveMon(starterMon, 50, ITEM_EVIOLITE);
    ScriptGiveMon(SPECIES_ARCEUS_NORMAL, 50, ITEM_ORAN_BERRY);
    ResetTasks();
    PlayBattleBGM();
